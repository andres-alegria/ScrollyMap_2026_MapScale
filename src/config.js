...
//  footer: 'Produced by Kartik Chandramouli | Cartography by Andrés Alegría',
  ...
  chapters: [
    ...
    // Chapter 1
    {
      ...
      alignment: 'left',
      title: ' ',
      description: "This is a satellite view of a beach in Akkampettai, a village near Puducherry.",
      images: [
        { src: 'LocationMap.png', position: 'bottom', title: '', alt: 'Puducherry in an inset map to show where it is in India' },
      ],
      location: { center: [79.85320, 10.9697], zoom: 14.80, pitch: 50, bearing: -28 },
      onChapterEnter: [
    ...
    // Chapter 2 — boats; slight pan south so the nesting site pan in ch3 reads as movement
    {
      ...
      location: { center: [79.85320, 10.9697], zoom: 18.16, pitch: 0, bearing: -28 },
      onChapterEnter: [
    ...
    // Chapter 3 — turtle nesting; pan ~200 m north of ch2 centre
    {
      ...
      location: { center: [79.85360, 10.97190], zoom: 18.15, pitch: 0, bearing: -28 },
      onChapterEnter: [
    ...
    // Chapter 4a
    {
      ...
      alignment: 'right',
      title: ' ',
      description: "Across the beach, blue tarpaulins stand out from above.",
      images: [
    ...
    // Chapter 4b
    {
      ...
      alignment: 'right',
      title: ' ',
      description: "This is a roughly 300 square metres fish-drying centre. For several fisherwomen, it means daily income.",
      images: [
        { src: 'image6.JPG', position: 'top', title: '', alt: 'Fisherwomen' },
      ],
      location: { center: [79.8516, 10.958], zoom: 17.250, pitch: 50, bearing: -28 },
      onChapterEnter: [
        { layer: 'icon_Turtle',              opacity: 0 },
    ...
    // Chapter 5
    {
      ...
      location: { center: [79.8516, 10.959621], zoom: 13.5, pitch: 0, bearing: 0 },
    },
    ...
    // Chapter 7
    {
      ...
      location: { center: [79.851655, 10.965644], zoom: 14.8, pitch: 0, bearing: 0 },
      onChapterEnter: [
       { layer: 'icon_Turtle',              opacity: 1 },
        { layer: 'icon_Boat',               opacity: 1 },
        { layer: 'icon_DryFish',            opacity: 1 },        
...
<p style="text-align:center; font-size:54px; font-weight:bold; font-family:'Rowan', serif;">Scale.</p>`,
      location: { center: [79.851655, 10.965644], zoom: 14.8, pitch: 0, bearing: 0 },
      onChapterEnter: [
        { layer: 'Akkampetai-overlay-14000',  opacity: 0 },
        { layer: 'Akkampetai-overlay-125000', opacity: 0 },
    ...
    // Chapter 13
    {
      ...
      alignment: 'left',
      title: ' ',
      description: "Authorities also prepared a finer map at 1:4,000 scale where one grid covers 2.7 × 2.7 kilometres. But this version will not go through public consultation.",
    ...
    // Chapter 14
    {
      ...
      stage: "PlainText",
      title: "",
      html: `<p style="text-align:center;">Fishing communities worry that not indicating every detail on the map, could lead to their spaces being opened up for tourism, real estate, or future infrastructure projects.</p>`,
    },
